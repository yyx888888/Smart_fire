...
<!-- 右侧表格 -->
  <div class="table left">
    <div class="box">
      ...
      <!-- 新增栏 -->
      <div class="add">
        <el-button class="addBtn" @click="addNew = true" ><img src="../../../public/images/u879.svg" alt="">添加巡检计划</el-button>
        <!-- 新增模态框 -->
      ...
      <template #footer>
        <span class="dialog-footer">
          ...
          <el-button @click="addNew = false;addPlan"><img src="../../../public/images/u1075.svg" alt="">保存</el-button >
        </span>
      </template>
  </el-dialog>
      </div>
      ...
      <template #footer>
        <span class="dialog-footer">
          <el-button @click="showMsg = false"><img src="../../../public/images/u1071.svg" alt="">取消</el-button>
          <el-button @click="showMsg= false"><img src="../../../public/images/u1075.svg" alt="">保存</el-button >
            ...
            <!-- 删除按钮 -->
          <el-button
          @click="handleDelete(scope.$index, scope.row);cancel = true"
          >删除</el-button>
          <!-- 确认删除 -->
          <!-- <el-dialog
            v-model="cancel"
